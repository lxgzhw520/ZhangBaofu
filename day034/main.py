...
@app.route('/hw_008.html')
def hw_008():
    return render_template('hw_008.html')


@app.route('/hw_009.html')
def hw_009():
    return render_template('hw_009.html')


@app.route('/hw_010.html')
def hw_010():
    return render_template('hw_010.html')
